...
export const JudgeForm: React.FC<JudgeFormProps> = ({ onStartRun, isStarting }) => {
  ...
  return (
    <div style={{ maxWidth: "900px", margin: "40px auto", padding: "0 24px" }}>
      <div style={{ textAlign: "center", marginBottom: "40px" }}>
        <h1 style={{ fontSize: "2.5rem", fontWeight: 700, marginBottom: "12px", background: "var(--judge-accent)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "grid", gridTemplateColumns: "1fr 350px", gap: "24px" }}>
        ...
        <div className="glass-panel" style={{ padding: "32px", borderRadius: "var(--border-radius-lg, 16px)" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            <label style={{ display: "block", marginBottom: "8px", color: "var(--text-secondary)", fontSize: "0.9rem" }}>Target Repository URL</label>
            <input
              type="text"
              value={repo}
          ...
          <div style={{ marginBottom: "32px" }}>
            <label style={{ display: "block", marginBottom: "8px", color: "var(--text-secondary)", fontSize: "0.9rem" }}>Finding ID (Issue/Vulnerability to Verify)</label>
            <input
              type="text"
              value={findingId}
          ...
          >
            {isStarting ? (
              <span style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                <span className="animate-spin" style={{ display: "inline-block", width: "20px", height: "20px", border: "2px solid #fff", borderTopColor: "transparent", borderRadius: "50%" }}></span>
                Initializing Agent...
              </span>
            ) : (
              <>
        ...
        <div className="glass-panel" style={{ padding: "24px", borderRadius: "var(--border-radius-lg, 16px)", height: "fit-content" }}>
          <h2 style={{ fontSize: "1.1rem", fontWeight: 600, marginBottom: "20px", display: "flex", alignItems: "center", gap: "8px", color: "var(--text-secondary)" }}>
            <Settings size={18} />
            Agent Settings
          </h2>
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", color: "var(--text-muted)", fontSize: "0.85rem" }}>
              <Cpu size={14} style={{ display: "inline", verticalAlign: "middle", marginRight: "4px" }} />
              Model Selection
            </label>
            <select
              value={modelName}
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px", color: "var(--text-muted)", fontSize: "0.85rem" }}>
              <span>Token Budget</span>
              <span style={{ color: "var(--accent-cyan)" }}>{tokenBudget.toLocaleString()}</span>
            </label>
            <input
              type="range"
